...
.. |GH-CI| image:: https://github.com/pyansys/pyacp-private/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/pyansys/pyacp-private/actions/workflows/ci.yml
    :alt: GH-CI
...
3. Install the project and all its development dependencies using poetry. This also takes care of
   creating a new virtual environment:
    ...
    .. code:: bash
        ...
        poetry install -E doc -E tests -E examples -E pre-commit -E build
